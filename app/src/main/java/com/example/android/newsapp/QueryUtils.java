...
public class QueryUtils {
     ...
     * directly from the cljava.lang.Stringass name QueryUtils (and an object instance of QueryUtils is not needed).
     */
    private QueryUtils() {
    }
    ...
    public static List<Article> extractArticleFromJson(String articleJSON) {
        ...
        // Parse the Guardian API. If there's a problem with the way the JSON
